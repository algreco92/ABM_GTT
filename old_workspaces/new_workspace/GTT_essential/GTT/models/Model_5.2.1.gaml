...
experiment Breakeven type: batch repeat: 1 until: time = 72000 + time_offset keep_seed: true
{
	parameter 'flip' var: Flip <- 0.5;
	parameter 'start_time' var: time_offset <- 146001.0;
	parameter 'input_csv' var: input_csv<- true;
	parameter 'percorso' var:salvataggio <- "./exports/23_11/";
	parameter 'n_controllori' var:n_controllori <- 4;	
