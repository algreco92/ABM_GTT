...
//			avg_risk_balance <- 0.0;
	...
	reflex shouldHalt when: time = 146000
	{
		write "halting";
    	do halt;
	}
...

{
	...
	reflex verification
	{
		...
		{//popolazione/peso sono gli agenti che erano su quell'edge. Peso va diviso per 48 (autobus che sono passati)
...
experiment stabilita type: batch repeat: 4 until: time = 156000 keep_seed: false {}
